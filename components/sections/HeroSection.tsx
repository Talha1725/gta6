...
const HeroSection: React.FC = () => {
  ...
  const handleScrollClick = (sectionId: string) => (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-7xl mx-auto w-full px-4">
            <div className="text-center">
              <h1 className="text-5xl sm:text-5xl md:text-6xl font-bold mb-6">
                <span className="text-pink-500 font-orbitron">
                  #1 GTA6 Pre-Order Hub
                </span>
              </h1>

              <p className="text-white text-lg md:text-xl mb-12 font-spaceMono">
